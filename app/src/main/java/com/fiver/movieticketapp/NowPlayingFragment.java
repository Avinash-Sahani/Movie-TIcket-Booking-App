...
public class NowPlayingFragment extends Fragment{
    ...
    private EditText phonenumber;    private RecyclerView movieslist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         moviesview = inflater.inflate(R.layout.fragment_now_playing, container, false);

        movieslist = (RecyclerView) (moviesview.findViewById(R.id.listmovies));

        movieslist.setLayoutManager(new LinearLayoutManager(getContext()));

        movieref = FirebaseDatabase.getInstance().getReference().child("NowPlayingMovies");
    ...
    public void onStart() {
        ...
        adapter = new FirebaseRecyclerAdapter<Movie, MovieViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final MovieViewHolder holder, int position, @NonNull Movie model) {
